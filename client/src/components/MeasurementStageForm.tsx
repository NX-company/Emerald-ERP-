...
import { CalendarIcon, Image, Video, Mic, Loader2, Check, Play, CheckCircle } from "lucide-react";
      ...
      <Card>
        ...
        <CardContent className="space-y-2 pb-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="space-y-1">
              <Label htmlFor="cost" className="text-xs text-muted-foreground">Стоимость</Label>
              <Input
                id="cost"
